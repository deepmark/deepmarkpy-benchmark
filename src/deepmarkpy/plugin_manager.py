...
class PluginManager:
    def __init__(self, plugins_dir=None):
        ...
        if plugins_dir is None:
            plugins_root = files("deepmarkpy.plugins")
            self.plugins_dir = str(
                self._resource_stack.enter_context(as_file(plugins_root))
            )
        else:
    ...
    def _load_attacks(self):
        ...
        self._load_classes_from_directory(
            ...
            package_prefix="deepmarkpy.plugins",
        )
    ...
    def _load_classes_from_directory(
        self, directory, base_class, storage_dict, package_prefix
    ):
        for root, _, files in os.walk(directory):
            ...
            if os.path.exists(config_path):
                try:
                    ...
                    if base_class is BaseAttack:
                        config_data = normalize_attack_config(
            ...
            for filename in files:
                ...
                # Build module path, e.g. "deepmarkpy.plugins.attacks.some_attack.attack"
