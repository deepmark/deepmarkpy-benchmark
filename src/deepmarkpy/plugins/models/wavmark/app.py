...
from inference import WavMarkEngine
...
async def embed(request: EmbedRequest):
    ...
    watermarked_audio = engine.embed(decode_audio(request.audio), request.watermark_data, request.sampling_rate)
