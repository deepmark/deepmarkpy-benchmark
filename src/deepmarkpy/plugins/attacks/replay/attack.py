...
class ReplayAttack(BaseAttack):
    ...
    def apply(self, audio: np.ndarray, **kwargs) -> np.ndarray:
        ...
        air_folder = kwargs.get("air_folder", self.config.get("air_folder", "AIR_wav_files"))
        air_sr = kwargs.get("air_sampling_rate", self.config.get("air_sampling_rate", 48000))
        bandpass = kwargs.get("bandpass", self.config.get("bandpass", True))
        low_freq = kwargs.get("low_freq", self.config.get("low_freq", 50))
        high_freq = kwargs.get("high_freq", self.config.get("high_freq", 8000))
        filter_order = kwargs.get("filter_order", self.config.get("filter_order", 4))
        add_noise = kwargs.get("add_noise", self.config.get("add_noise", True))
        snr_db = kwargs.get("snr_db", self.config.get("snr_db", 50))
