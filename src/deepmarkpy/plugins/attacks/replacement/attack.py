...
from deepmarkpy.plugins.attacks.replacement.replacement_attack import replacement_attack
...
class ReplacementAttack(BaseAttack):
    ...
    def apply(self, audio: np.ndarray, **kwargs) -> np.ndarray:
        ...
        overlap_factor = kwargs.get(
            "overlap_factor", self.config.get("overlap_factor")
        )
        ...
        use_masking = kwargs.get(
            "use_masking", self.config.get("use_masking")
        )
